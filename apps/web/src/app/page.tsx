...
function ActivityCard({
  ...
  const inner = (
    <div
      className={`kid-surface flex h-full min-h-[5.5rem] items-center gap-3.5 p-3.5 transition duration-200 sm:block sm:min-h-[7.5rem] sm:gap-4 sm:p-5 md:p-6 ${border} ${disabled ? 'opacity-90' : 'cursor-pointer hover:-translate-y-1 hover:shadow-lg'} ${highlight && !disabled ? 'ring-2 ring-amber-300 ring-offset-1' : ''}`}
    >

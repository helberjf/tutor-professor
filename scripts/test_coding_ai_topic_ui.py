...
def main() -> None:
    ...
    require("${base}/subjects/${subjectId}/topics/generate" in api_source, "API client targets the generated-topic route")
    ...
    require("curriculum.generateCodingTopicContent(topic.id, { context:" in topic_view, "regenerate context is sent to the topic generation API")

...
def main() -> None:
    ...
    require("Sugerir matéria com IA" not in source, "AI subject suggestion button was removed from the overview")
    require("Sugerir tópico com IA" in source, "subject dashboard can ask AI to choose a topic")
